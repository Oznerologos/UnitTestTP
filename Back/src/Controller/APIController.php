...
class APIController extends AbstractController
{
    ...
    public function product(Request $request, Product $product, RickAndMortyGestion $rickAndMortyGestion ): Response
    {
        return $this->json($rickAndMortyGestion->findById($product->getId()));
    }
